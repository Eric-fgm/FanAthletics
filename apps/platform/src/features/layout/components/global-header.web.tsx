...
const GlobalHeader: React.FC = () => {
	...
	return (
		<View className="z-10 items-center gap-x-8 grid grid-cols-[1fr_1fr] lg:grid-cols-[1fr_minmax(auto,520px)_1fr] grid-rows-1 bg-white px-4 lg:px-12 w-full h-16">
			...
			<View className="flex-row justify-end items-center gap-x-4 min-w-min">
				<View className="flex-row gap-x-2">
					<View className="lg:hidden flex justify-center items-center bg-white border border-gray-200 rounded-full w-9 h-9">
						<Search size={16} />
					</View>
					<View className="justify-center items-center bg-white border border-gray-200 rounded-full w-9 h-9">
						<Bell size={16} />
					</View>
				</View>
				<Button
